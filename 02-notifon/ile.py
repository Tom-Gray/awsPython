c2 = boto3.resource('ec2')
    ...
    mysg.authorize_ingress(IpProtocol="tcp",CidrIp="220.101.115.218/32",FromPort=22,ToPort=22) 
...
security_group.authorize_ingress(IpProtocol="tcp",CidrIp="220.101.115.218/32",FromPort=22,ToPort=22)
